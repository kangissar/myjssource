...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Show all ' + postTitle.length + ' posts<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Show ' + numDisplayed + ' posts labeled \'';
...
function showToc() {
  ...
  else { alert("Please wait... Sitemap is loading"); }
}
